...
Fork the following repo `https://github.com/diegorodrigues87/backstage-demo` to your organization.
...
cd backstage-demo
find . -type f -not -path '*/\.git/*' -exec sed -i "s/diegorodrigues87/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/diegorodrigues87/${github_organization}/g" {} +
find . -type f -not -path '*/\.git/*' -exec sed -i "s/ocp-nprd-4-6.sp.elocloud/${base_domain}/g" {} +
git add -A
...
Fork the following repo `https://github.com/diegorodrigues87/shared-workflows` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/diegorodrigues87/software-templates` to your organization.
Then execute the following commands
...
Fork the following repo `https://github.com/diegorodrigues87/backstage-app-demo` to your organization.
